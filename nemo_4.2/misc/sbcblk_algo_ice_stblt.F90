MODULE sbcblk_algo_ice_stblt
   ...
   !!
   !!       Routine turb_ice_stblt maintained and developed in AeroBulk
...
CONTAINS
   ...
   SUBROUTINE turb_ice_stblt( zt, zu, Ts_i, t_zt, qs_i, q_zt, U_zu,        &
      &                      CdN, ChN, CeN,                               &
      &                      Cd_i, Ch_i, Ce_i, t_zu_i, q_zu_i,            &
      &                      xz0, xu_star, xL, xUN10 )
      !!----------------------------------------------------------------------
      !!                      ***  ROUTINE  turb_ice_stblt  ***
      !!
      ...
      !!
      CHARACTER(len=40), PARAMETER :: crtnm = 'turb_ice_stblt@sbcblk_algo_ice_stblt.f90'
      !!----------------------------------------------------------------------------------
   ...
   !!======================================================================
END MODULE sbcblk_algo_ice_stblt
